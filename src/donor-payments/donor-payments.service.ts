...
import { DonorPayment, DonorPaymentDocument } from '../schemas/donor-payment.schema';

@Injectable()
export class DonorPaymentsService {
  private readonly store: MongoEntityService;

  constructor(@InjectModel(DonorPayment.name) model: Model<DonorPaymentDocument>) {
